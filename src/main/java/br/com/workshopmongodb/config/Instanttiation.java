...
public class Instanttiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("28/02/2018"), "Partiu Viagem", "Vou viajar para são paulo, abraços!", maria);
		Post post2 = new Post(null, sdf.parse("30/02/2018"), "Opa querida", "Vou viajar para o Rio, abraços!", maria);
